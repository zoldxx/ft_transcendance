...
SECRET_KEY = 'django-insecure--5m=ne26r680d3kax+yhvk$l+zhd-mktav!z(x(-=eyvq93ng3'
...
ROOT_URLCONF = 'user_management_files.urls'
...
AUTH_USER_MODEL = 'user_management_files.User'

CSRF_TRUSTED_ORIGINS = os.getenv('CSRF_TRUSTED_ORIGINS', 'http://localhost').split(',')
CRSF_COOKIE_SECURE = True
SESSION_COOKIE_SECURE = True

WSGI_APPLICATION = 'user_management_files.wsgi.application'
